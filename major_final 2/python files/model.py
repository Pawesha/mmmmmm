...
excel_file_path = "/Users/paweshashrestha/Downloads/major_final 2/python files/new/refined_dataset.xlsx"
...
if df.shape[0] > 0:
    ...
    df_evaluation_metric.to_excel("/Users/paweshashrestha/Downloads/major_final 2/python files/new/metrics.xlsx", index=False)

    # Save true and predicted values to an Excel file
    save_true_predicted_values(models, X_test, y_test, "/Users/paweshashrestha/Downloads/major_final 2/python files/new/true_predicted_values.xlsx")
